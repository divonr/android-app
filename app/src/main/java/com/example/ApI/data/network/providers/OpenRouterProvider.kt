...
class OpenRouterProvider(context: Context) : BaseProvider(context) {
    ...
    /**
     * Handles tool call execution and chaining for OpenRouter
     */
    ...
    private suspend fun makeStreamingRequest(
        ...
        try {
            ...
            val requestBody = buildRequestBody(
                modelName, openRouterMessages, enabledTools, thinkingBudget, temperature
            )
    ...
    private fun parseStreamingResponse(
        ...
        return when {
            ...
            else -> ProviderStreamingResult.Error("Empty response from OpenRouter")
        }
    }
